...
class Ui_CavityLengthScan(object):
    ...
    def retranslateUi(self, apdMonitor):
        apdMonitor.setWindowTitle(QCoreApplication.translate("CavityLengthScan", u"MainWindow", None))
        ...
        self.cavityName.setPlainText(QCoreApplication.translate("CavityLengthScan", u"F15P2_Planar", None))
        ...
        self.checkSweepFrequency.setText(QCoreApplication.translate("CavityLengthScan", u"Sweep Laser", None))

        self.label.setText(QCoreApplication.translate("CavityLengthScan", u"Sweep Frequency", None))
