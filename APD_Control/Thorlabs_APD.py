...
class APD_Reader(object):
    ...
    """
    def __init__(self,channel,size_of_channel):
        """
        Inputs:
       ...
       # nidaqmx.Task().timing.cfg_samp_clk_timing(rate = 1000000,sample_mode = nidaqmx.constants.AcquisitionType.CONTINUOUS)
        ...
        self._apd.ai_channels.add_ai_voltage_chan(channel)
        self._rate = 100000
        self._size_of_channel = size_of_channel
        self._apd.timing.cfg_samp_clk_timing(rate = 1000000,sample_mode = nidaqmx.constants.AcquisitionType.CONTINUOUS)
